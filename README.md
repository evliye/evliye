...
Middle iOS Developer, delivering high-quality experiences across iPhone, iPad. Skilled in Swift, SwiftUI, and UIKit, with
deep experience in modern architectures like TCA and MVVM-C. Advocate of clean, maintainable code with a strong
focus on performance optimization using structured concurrency (GCD, Operations and async/await), and ARC.
